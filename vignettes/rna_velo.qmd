...
for i in loom_files:
    ...
    sample_id = i[0:5:1]
    #add object to list
    tmp = anndata.read_loom("loom_files/"+i)
...
#merge anndata list
merged_anndata = anndata.concat(ad_obs, join = outer)
```
...
scv.pl.velocity_embedding_stream(merged_anndata, basis = "umap", color = "james_cell_type")
```